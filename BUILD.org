...
|-----------+----------------+-----------------------------------+---------------------------+--------------------|
| Hetionet  | =hetionet=     | Many - see =populate-ontology.py= | [[https://github.com/hetio/hetionet/tree/master/hetnet/tsv][GitHib]]                    | [[Hetionet]]           |
...
- Homo_sapiens_expr_advanced_development.tsv (from the Bgee database)
...
that are used to create ontology entities.
